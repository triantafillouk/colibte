 ...
 switch(tok0->ttype) {
	...
	case TOK_VAR:{	// 0 variable
		...
		if(tok->ttype==TOK_TYPE_ELEMENT) {
			...
			// set_bnf_function1(tok,tok->ttype);
			tok->dval=-1;
			stack_push("type_element",tok,tok->ttype);
			NTOKEN_ERR(4982);
		};
#endif
