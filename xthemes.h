...
// Midnight
 {
	...
	{"#005080",CYAN    ,0}, // COLOR_SELECT_BG,	MODEBACK
	{"#A00000",RED     ,0}, // COLOR_SEARCH_BG,	SEARBACK
	{"#005000",GREEN   ,0}, // COLOR_QUOTE_BG,		QUOTEBACK
	{"#202025",BROWN   ,0}, // COLOR_LIGHT_BG,		LBACKGROUND
	{"#282828",BROWN   ,0}, // COLOR_INFO_BG,		INFOBACK
	{"#383838",BLUE    ,0}, // COLOR_INACTIVE_BG,	MODEBACKI
	{"#303030",BLUE    ,0}, // COLOR_BOX_BG,		CBOXTBACK ???????
	{"#404040",BLACK   ,0}, // COLOR_CODE_BG		color code bg
	...
	{"#F0F000",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
...
// Blue Sky
 {
	...
	{"#D00000",RED     ,0}, // COLOR_SEARCH_BG,	SEARBACK
	{"#008000",GREEN   ,0}, // COLOR_QUOTE_BG,		QUOTEBACK
	{"#204060",BROWN   ,0}, // COLOR_LIGHT_BG,		LBACKGROUND
	{"#404030",BLUE    ,0}, // COLOR_INFO_BG,		INFOBACK
	{"#004040",CYAN    ,0}, // COLOR_INACTIVE_BG,	MODEBACKI
	{"#008080",CYAN    ,0}, // COLOR_BOX_BG,		CBOXTBACK ???????
	{"#004050",BROWN   ,0}, // COLOR_CODE_BG		color code bg
	{"#D0D0D0",WHITE   ,0}, // COLOR_FG=BG_COLORS,	FOREGROUND, INFOFORE, QUOTEFORE,CBOXTFORE
	{"#FFFFFF",WHITE   ,0}, // COLOR_MENU_FG
	{"#FFF0F0",LWHITE  ,0}, // COLOR_STANDOUT_FG,	SEARFORE, CNUMERIC, CBOXFORE
	{"#FF0000",LRED    ,0}, // COLOR_CTRL_FG,		menu start fg, CTRLFORE
	{"#FFFF00",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
	{"#D00000",LCYAN   ,0}, // COLOR_WORD1_FG,		WORD1FORE
	{"#00FFFF",LMAGENTA,0}, // COLOR_WORD2_FG,		WORD2FORE
	{"#F000F0",LBLUE   ,0}, // COLOR_WORD3_FG,		W_FORE
	{"#00FF00",LGREEN  ,0}, // COLOR_SPEC_FG,		SPECFORE
...
// Gray
 {
	...
	{"#D0D0D0",BROWN   ,0}, // COLOR_CODE_BG		color code bg
	{"#000000",BLACK   ,0}, // COLOR_FG=BG_COLORS,FOREGROUND,INFOFORE,QUOTEFORE,CBOXTFORE
	{"#F2F2F2",WHITE   ,0}, // COLOR_MENU_FG
	{"#004090",LWHITE  ,0}, // COLOR_STANDOUT_FG,	SEARFORE, CNUMERIC, MENUSTART, MENU_FG, CBOXFORE
	{"#FF4D4D",LRED    ,0}, // COLOR_CTRL_FG,		menu start fg, CTRLFORE
	{"#FFFF00",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
	{"#8C008C",LCYAN   ,0}, // COLOR_WORD1_FG,		WORD1FORE
	{"red4"   ,LMAGENTA,0}, // COLOR_WORD2_FG,		WORD2FORE
	{"#00FFFF",LBLUE   ,0}, // COLOR_WORD3_FG,		W_FORE
	{"#00D0D0",LGREEN  ,0}, // COLOR_SPEC_FG,		SPECFORE
	{"#508050",GREEN   ,0}, // COLOR_SQUOTE_FG,	SQUOTEFORE
	{"#F5E5B5",ORANGE  ,0}, // COLOR_COMMENT_FG,	COMMENTFORE
...
// Sunny
 {
	...
	{"#808080",BLUE    ,0}, // COLOR_BOX_BG,		CBOXTBACK
	{"#A8A8A8",BROWN   ,0}, // COLOR_CODE_BG		color code bg
	{"#000000",BLACK   ,0}, // COLOR_FG=BG_COLORS,	FOREGROUND, INFOFORE, QUOTEFORE,CBOXTFORE
	{"#FFFFFF",WHITE   ,0}, // COLOR_MENU_FG
	...
	{"#AE0000",LCYAN   ,0}, // COLOR_WORD1_FG,		WORD1FORE
	{"#FF00FF",LMAGENTA,0}, // COLOR_WORD2_FG,		WORD2FORE
	{"#A04040",LBLUE   ,0}, // COLOR_WORD3_FG,		W_FORE
	{"#009900",LGREEN  ,0}, // COLOR_SPEC_FG,		SPECFORE
	{"#00A900",GREEN   ,0}, // COLOR_SQUOTE_FG,	SQUOTEFORE
	{"#A04040",ORANGE  ,0}, // COLOR_COMMENT_FG,	COMMENTFORE
...
// Twilight
 {
	...
	{"#006688",BLUE    ,0}, // COLOR_MENU_BG,		MENU_BG
	{"#005070",CYAN    ,0}, // COLOR_SELECT_BG,	MODEBACK
	...
	{"#454545",BROWN   ,0}, // COLOR_CODE_BG		color code bg
	...
	{"#FFFF00",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
	{"#CD7C33",LCYAN   ,0}, // COLOR_WORD1_FG,		WORD1FORE
	{"#F9EE98",LMAGENTA,0}, // COLOR_WORD2_FG,		WORD2FORE
	{"#F0AD80",LBLUE   ,0}, // COLOR_WORD3_FG,		W_FORE
	{"#90EE90",LGREEN  ,0}, // COLOR_SPEC_FG,		SPECFORE
	{"#90EE90",GREEN   ,0}, // COLOR_SQUOTE_FG,	SQUOTEFORE
	{"#707080",ORANGE  ,0}, // COLOR_COMMENT_FG,	COMMENTFORE
...
// Lunar
 {
	...
	{"#FFF0F0",LWHITE  ,0}, // COLOR_STANDOUT_FG,	SEARFORE, CNUMERIC, CBOXFORE
	{"#FF4D4D",LRED    ,0}, // COLOR_CTRL_FG,		menu start fg, CTRLFORE
	{"#FF90FF",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
...
// Velvet
 {
	...
	{"#E0E0E0",WHITE   ,0}, // COLOR_MENU_FG
	{"#B4BF76",LWHITE  ,0}, // COLOR_STANDOUT_FG,	SEARFORE, CNUMERIC, CBOXFORE
	{"#F00000",LRED    ,0}, // COLOR_CTRL_FG,		menu start fg, CTRLFORE
	{"#F0F000",YELLOW  ,0}, // COLOR_PREP_FG,		PREPFORE
	{"#D06060",LCYAN   ,0}, // COLOR_WORD1_FG,		WORD1FORE
	{"#559BD5",LMAGENTA,0}, // COLOR_WORD2_FG,		WORD2FORE
	{"#B4BF76",LBLUE   ,0}, // COLOR_WORD3_FG,		W_FORE
	{"#FFFFFF",LGREEN  ,0}, // COLOR_SPEC_FG,		SPECFORE
	{"#699854",GREEN   ,0}, // COLOR_SQUOTE_FG,	SQUOTEFORE
	{"#699854",ORANGE  ,0}, // COLOR_COMMENT_FG,	COMMENTFORE
	{"#CD9000",ORANGE  ,0}, // COLOR_CHANGE_FG,	CHANGEFORE
	{"#A000A0",LMAGENTA,0}, // COLOR_HORIZON_FG,	ORIZON
	{"#A0A0A0",WHITE   ,0}, // COLOR_INACTIVE_FG,	MODEFOREI
	{"#FFFF00",YELLOW  ,0}  // COLOR_ROWCOL_FG		DROWCOL
 }
};
