...
static void bnf_factor_pp_num_mul()
{
 double valb = bnf_var->var_pointer->dval;
 prev_var("pp_mul2");
...
static void bnf_increase_by_pp_num()
{
...
static void bnf_increase_by_pn_num()
{
